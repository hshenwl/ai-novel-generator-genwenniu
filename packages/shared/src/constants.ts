...
// 应用配置
export const APP_NAME = 'AI小说创作系统';
...
// 七步创作引擎步骤名称
export const SEVEN_STEP_AGENTS = {
  PLANNER: 'Planner',
  WRITER: 'Writer',
...
// 叙事视角
export const NARRATIVE_PERSPECTIVES = ['第一人称', '第三人称'] as const;

// 角色类型
export const CHARACTER_ROLES = ['主角', '配角', '反派', '导师', '路人'] as const;
...
// 伏笔类型
export const FORESHADOW_TYPES = [
  '身份', '道具', '秘密', '能力', '关系', '世界观',
] as const;

// AI去味模式
export const AI_DE_FLAVOR_MODES = {
  // A. 句式去味
  SENTENCE: {
