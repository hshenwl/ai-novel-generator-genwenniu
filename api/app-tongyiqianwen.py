...
# API Configurations — 请通过环境变量设置 API Key
# export DASHSCOPE_API_KEY="your-dashscope-key-here"
import os
API_KEY_1 = os.environ.get('DASHSCOPE_API_KEY', 'your-api-key-here')
API_KEY_2 = os.environ.get('DASHSCOPE_API_KEY_2', API_KEY_1)
